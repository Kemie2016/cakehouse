          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li>
                  <a href="edit.php?PageID=1">關於我們</a>
                </li>
                <li>
                  <a href="edit.php?PageID=2">購物說明</a>
                </li>
                <li>
                  <a href="edit.php?PageID=3">會員條款</a>
                </li>
              </ul>
            </li>
            <li class="active">
        ...
        <div class="row">
          <div class="col-md-12">
            <ul class="breadcrumb">
              ...
              <li>
                <a href="edit.php?PageID=1">頁面管理</a>
              </li>
          ...
          <div class="col-md-12">
            <form class="form-horizontal" role="form" action="edit.php" method="post" id="EditForm">
              ...
              <div class="form-group">
                <div class="col-sm-2">
                  <label for="Title" class="control-label"><?php echo $page['Title']; ?></label>
                </div>
                <div class="col-sm-10">
                  <?php echo $page['Title']; ?>
                </div>
              ...
              <div class="form-group">
                <div class="col-sm-10 col-sm-offset-2 text-right">
                  ...
                  <input type="hidden" class="form-control" id="PageID" name="PageID" value="<?php echo $page['PageID'];?>">
                  <button type="submit" class="btn btn-default" onclick="alert('已更新')">送出</button>
